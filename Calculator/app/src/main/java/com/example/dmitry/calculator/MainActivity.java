...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstOperand = findViewById(R.id.editText2);
        firstOperand.setEnabled(false);

        operation = findViewById(R.id.textView4);

        secondOperand = findViewById(R.id.editText3);
        ...
        firstGo = findViewById(R.id.firstOperandGo);
        firstGo.addOnGesturePerformedListener(this);

        operationGo = findViewById(R.id.operationGo);
        ...
        secondGo = findViewById(R.id.secondOperandGo);
